...
def make_human():
    ...
    # Create a skeleton to use for animating blendshapes and bind it to the skelroot
    skeleton = UsdSkel.Skeleton.Define(stage, skel_root.GetPath().AppendChild("blendshape_skeleton"))
